...
const SUBJECTS = [
  ...
  { name: "Financial Accounting", emoji: "💰", color: "green",  levels: "ss" },
  { name: "Basic-science",       emoji: "🔬", color: "teal",   levels: "jss" },
  { name: "Basic-technology",    emoji: "💻", color: "blue",   levels: "jss" },
  { name: "Business-studies",    emoji: "📊", color: "orange", levels: "jss" },
];
